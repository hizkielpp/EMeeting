...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        (new User(['username' => 'Dekan', 'nickname' => 'Yan Wisnu Prajoko', 'role' => 'pimpinan', 'email' => 'dekan@gmail.com', 'password' => 'password']))->save();
        (new User(['username' => 'S1 Dokter', 'nickname' => 'Hizkiel Putra Pakubumi', 'role' => 'bawahan', 'email' => 's1dokter@gmail.com', 'password' => 'password']))->save();
        (new User(['username' => 'S2 Dokter', 'nickname' => 'Damianus Ardi', 'role' => 'bawahan', 'email' => 's2dokter@gmail.com', 'password' => 'password']))->save();
        (new User(['username' => 'S3 Dokter', 'nickname' => 'Okta Setiawan', 'role' => 'bawahan', 'email' => 's3dokter@gmail.com', 'password' => 'password']))->save();
        (new User(['username' => 'IT', 'nickname' => 'Ardi', 'role' => 'admin', 'email' => 'it@gmail.com', 'password' => 'password']))->save();
        User::all();
