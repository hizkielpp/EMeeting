        ...
        <div class="card-body">
            ...
            <form class="needs-validation" action="{{ route('update_laporan') }}" method="POST" style="border-top: #006b1a 2px"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_rapat" class="form-control" value="{{ $laporan->nama_rapat }}"
                        required>
                ...
                <div class="mb-3 fs__child form-label">
                    Tanggal Rapat<span class="text-danger">*</span><input name="tanggal_rapat" type="text"
                        class="fs__normal form-control" id="tanggal_rapat"
                ...
                <div class="mb-3 fs__child form-label">
                    Jam Rapat<span class="text-danger">*</span><input name="jam_rapat" type="time"
                        class="fs__normal form-control" id="jam_rapat"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tempat" class="form-control" required value="{{ $laporan->tempat }}">
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="pencatat" class="form-control" required value="{{ $laporan->pencatat }}">
                    <div class="invalid-feedback">
                ...
                <div class="row gap-2 mb-2" style="margin-left: 0.20rem!important">
                    <div class="col-lg-5 col-sm-12 signature-pad-form fs__child m-0 p-0" id="form_tanda_tangan_pejabat">
                        ...
                        <input type="text" id="nama_jabatan_pejabat" name="nama_jabatan_pejabat" class="form-control"
                        ...
                        <label for="nama_pejabat" class="fs__child  w-100">Nama Pejabat
                            <span class="text-danger">*</span></label>
                        <input type="text" id="nama_pejabat" name="nama_pejabat" class="form-control" required
                        ...
                        <label for="NIP_pejabat" class="fs__child  w-100">NIP Pejabat
                            <span class="text-danger">*</span></label>
                        <input type="text" id="NIP_pejabat" name="NIP_pejabat" class="form-control" required
                            value="25">
                        <div class="invalid-feedback">
                    ...
                    <div id="container-KSM"
                        class="col-lg-5 col-sm-12 signature-pad-form fs__child {{ is_null($laporan->tanda_tangan_KSM) ? 'd-none' : '' }}  m-0 p-0"
                        id="form_tanda_tangan_ksm">
                        <label for="nama_jabatan_KSM" class="fs__child  w-100">Jabatan Ketua KSM
                            <span class="text-danger">*</span></label>
                        <input type="text" id="nama_jabatan_KSM" name="nama_jabatan_KSM" class="form-control"
                        ...
                        <input type="text" id="nama_KSM" name="nama_KSM" class="form-control"
                            value="{{ is_null($laporan->nama_KSM) ? '' : $laporan->nama_KSM }}">
                        <label for="NIP_KSM" class="fs__child  w-100">NIP Ketua KSM
                        </label>
                        <input type="text" id="NIP_KSM" name="NIP_KSM" class="form-control"
                            value="{{ is_null($laporan->NIP_KSM) ? '' : $laporan->NIP_KSM }}">
                    </div>
                </div>
                <div class="col-6 mb-3 fs__child">
                    <label for="bukti_presensi_kehadiran">Bukti presensi kehadiran
                    ...
                    <input type="file" name="bukti_presensi_kehadiran" id="bukti_presensi_kehadiran"
                        class="form-control" id="" maxlength="1200"
                ...
                <div class="col-6 mb-3 fs__child">
                    <label for="file_pendukung_rapat">File pendukung rapat
                        <br>Upload ulang apabila ingin mengubah gambar yang tersimpan
                    </label>
                    <input type="file" name="file_pendukung_rapat" id="file_pendukung_rapat" class="form-control"
                ...
                <div class="mb-3">
                    ...
                    <textarea name="persoalan_yang_dibahas" class="form-control valued" id="" cols="30" rows="10"
                ...
                <div>
                    ...
                    <textarea maxlength="1200" name="tanggapan_peserta_rapat" id="tanggapan_peserta_rapat" class="form-control valued"
                        cols="30" rows="10" required>{{ $laporan->tanggapan_peserta_rapat }}</textarea>
                    <div class="invalid-feedback">
