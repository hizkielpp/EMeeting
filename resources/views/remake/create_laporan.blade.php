        ...
        <div class="card-body">
            ...
            <form class="needs-validation" action="{{ route('input_laporan') }}" method="POST" style="border-top: #006b1a 2px"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="Rapat" name="nama_rapat" class="form-control" required>
                ...
                <div class="mb-3 fs__child form-label">
                    Tanggal Rapat<span class="text-danger">*</span><input name="tanggal_rapat" value="{{ date('m/d/Y') }}"
                        type="text" class="fs__normal form-control" id="tanggal_rapat" required>
                    <div class="invalid-feedback">
                ...
                <div class="mb-3 fs__child form-label">
                    Jam Rapat<span class="text-danger">*</span><input name="jam_rapat" type="time" value=""
                        class="fs__normal form-control" id="jam_rapat" required>
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tempat" class="form-control" required value="Ruang A">
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="pemimpin_rapat" class="form-control" required value="Pak B">
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="pencatat" class="form-control" required value="Pak C">
                    <div class="invalid-feedback">
                ...
                <div class="row gap-2 mb-2" style="margin-left: 0.20rem!important">
                    ...
                    <div id="container-KSM" class="col-lg-5 col-sm-12 signature-pad-form fs__child d-none m-0 p-0"
                        ...
                        <label for="nama_jabatan_KSM" class="fs__child  w-100">Jabatan Ketua KSM
                            <span class="text-danger">*</span></label>
                        <input type="text" value="Ketua KSM" id="nama_jabatan_KSM" name="nama_jabatan_KSM"
                            class="form-control">
                ...
                <div class="col-6 mb-3 fs__child">
                    ...
                    <input type="file" name="bukti_presensi_kehadiran" id="bukti_presensi_kehadiran"
                        class="form-control" id="" maxlength="1200" accept=“.png,.jpg,.jpeg,.webp,image/png”
                        required></input>
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <label for="mahasiswa">Perihal Mahasiswa<span class="text-danger">*</span><br><span
                    ...
                    <div>
                        <label for="tendik">Perihal Tendik<span class="text-danger">*</span><br><span
                                class="fs__normal">Contoh :
                                tendik
                    ...
                    <div>
                        <label for="sarpras">Perihal sarana prasarana<span class="text-danger">*</span><br><span
                                class="fs__normal">Contoh
