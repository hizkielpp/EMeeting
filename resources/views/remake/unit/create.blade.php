...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            {{-- create notula --}}
            <form class="needs-validation" action="{{ route('input_unit') }}" method="POST" style="border-top: #006b1a 2px"
                enctype="multipart/form-data" novalidate>
                @csrf
                <div class="mb-3">
                    <label class="form-label">Nama Unit<span class="text-danger">*</span></label>
                    <input type="text" name="nama_unit" class="form-control bc" required>
