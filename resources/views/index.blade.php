...
@section('body')
    <form class="row shadow needs-validation m-0 p-3 mx-5 rounded bg-white bg-opacity-75"
        ...
        <div class="col-12 mb-3 fs__child">
            <label for="lain-lain">Lain-lain <span class="fs__normal">Seluruh perihal yang tidak termasuk 4 perihal
                    diatas
        ...
        <div class="col-lg-6 col-sm-12 signature-pad-form" id="form_tanda_tangan_kaprodi">
            <label for="tanda_tangan_kaprodi" class="fs__child">Tanda tangan ketua program studi<span
                    class="text-danger">*</span></label>
            <canvas height="200" width="600" class="signature-pad" id="canvas_tanda_tangan_kaprodi"></canvas>
            <p><a href="#" class="btn w-100" id="clear_tanda_tangan_kaprodi">Clear</a></p>
            <input type="hidden" name="tanda_tangan_kaprodi" id="tanda_tangan_kaprodi">
            {{-- <button class="submit-button" id="submit_tanda_tangan_kaprodi">SUBMIT</button> --}}
        </div>
        <div class="col-lg-6 col-sm-12 signature-pad-form" id="form_tanda_tangan_kadep">
            <label for="tanda_tangan_kaprodi" class="fs__child">Tanda tangan ketua program studi<span
                    class="text-danger">*</span></label>
            <canvas height="200" width="600" class="signature-pad" id="canvas_tanda_tangan_kadep"></canvas>
            <p><a href="#" class="btn w-100" id="clear_tanda_tangan_kadep">Clear</a></p>
            <input type="hidden" name="tanda_tangan_kadep" id="tanda_tangan_kadep">
