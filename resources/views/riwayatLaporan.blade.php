...
@endsection
@section('body')
    <div class="m-0 p-3 rounded bg-white bg-opacity-75">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="text-center d-flex gap-1">
                        ...
                        <div class="btn btn-auto bg-green p-1 d-flex flex-column" data-bs-toggle="modal"
                            data-bs-target="#modalDetail">
                            <i class="fa fa-info-circle mx-auto my-auto"></i>
                            Detail
                        </div>
                        <!-- Button untuk melihat modal ubah detail laporan-->
                        <div class="btn btn-auto bg-orange p-1 d-flex flex-column" data-bs-toggle="modal"
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <input type="text" id="datepicker" value="08-08-2001"
                                            class="form-control w-100 bg-grey p-1 rounded">
                                        <div>
                                            Perihal Mahasiswa :
                                        </div>
                                        <textarea class="form-control w-100 bg-grey p-1 rounded" name="" id="" cols="30" rows="8">
